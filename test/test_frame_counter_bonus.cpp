...
static const AddBonusTestCase bonus_test_cases[] = {
    {BonusType::None, -1, -1, true,
     FrameFactoryHelper::COMPLETE}, // complete - no bonus allowed
    {BonusType::None, -1, -1, true,
     FrameFactoryHelper::INCOMPLETE}, // incomplete - bo bonus
...
INSTANTIATE_TEST_SUITE_P(BonusValidationCases, CounterAddBonusSuite,
