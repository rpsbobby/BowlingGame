...
class CompletenessBonusTests
    : public testing::TestWithParam<CompletenessBonusCase> {};
...
INSTANTIATE_TEST_SUITE_P(CompletenessBonusCases, CompletenessBonusTests,
                         ::testing::ValuesIn(completeness_bonus_cases));
