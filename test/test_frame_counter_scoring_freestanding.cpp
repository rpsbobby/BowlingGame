...
TEST(ScoreFreestanding,
     should_throw_when_score_called_but_spare_bonus_missing) {
  FrameCounter counter;
...
TEST(ScoreFreestanding,
     should_throw_when_score_called_but_strike_bonus_missing) {
  FrameCounter counter;
...
TEST(ScoreFreestanding,
     should_not_throw_when_score_called_and_game_is_complete) {
  FrameCounter counter;
